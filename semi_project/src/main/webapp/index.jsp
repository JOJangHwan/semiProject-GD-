            ...
            <nav>
                <div class="logo">
                    <i class="bx bx-menu menu-icon"></i>
                        <a href=""><img src="./images/semilogo.gif" id="semilogo" alt="로고" height="70px"></a>
                </div>
                    <!-- 토글? -->
                    <div class="sidebar">
                        <!-- 로고 -->
                ...
                <!-- 로그인? -->
                <div id="login"><a href="<%=request.getContextPath()%>/login/loginView.do"><img id="loginlogo" src="./images/로그인.png" alt="마이페이지"></a></div>
        </div>    
    </header>
                        <script>
    ...
    <div id="content">
        <!-- 메인화면사진 -->
            ...
            <div id="search">
                    ...
                    <button type="button" class="btn btn-outline-warning"><img src="./images/검색.png" alt="" style="height: 25px;" style="width: 25px;"></button>
            </div>
            <div class="blank"></div>
            <!-- 메인 메뉴 -->
            <div id="snb">
                <a id="map"><img src="./images/여행지.png" alt=""><br>여행지</a>
                <a id="route"><img src="./images/동선저장.png" alt=""><br>내 동선</a>
                <a id="rec"><img src="./images/추천 동선.png" alt=""><br>추천 동선</a>
                <a id="like"><img src="./images/찜.png" alt=""><br>찜</a>
            </div>
    </div>
</section> 
    <footer>
