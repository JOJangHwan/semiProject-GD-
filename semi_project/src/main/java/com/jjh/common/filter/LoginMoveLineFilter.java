 ...
 * if(loginMember!=null) { //로그인을 했다... 회원보기 요청한 아이디랑 일치하면.... //화면보여줘
 * chain.doFilter(request, response); }else { request.setAttribute("msg",
 * "로그인을 하세요 :("); request.setAttribute("loc", "/");
...
// */
//@WebFilter("/moveLine/*")
//public class LoginMoveLineFilter extends HttpFilter implements Filter {
//       
//    /**
//     * @see HttpFilter#HttpFilter()
//     */
//    public LoginMoveLineFilter() {
//        super();
