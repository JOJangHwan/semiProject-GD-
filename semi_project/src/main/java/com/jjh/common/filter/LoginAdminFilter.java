...
// */
//@WebFilter("/admin/*")
//public class LoginAdminFilter extends HttpFilter implements Filter {
//       
//    /**
 ...
 *//**
	 ...
	 */
/*
 * @WebFilter("/admin/*") public class LoginAdminFilter extends HttpFilter
 * implements Filter {
 * 
 *//**
	 * @see HttpFilter#HttpFilter()
	 */
/*
 * public LoginAdminFilter() { super(); // TODO Auto-generated constructor stub
 * }
 * 
 *//**
	 * @see Filter#destroy()
 ...
 * 
 * // pass the request along the filter chain HttpSession
 * session=((HttpServletRequest)request).getSession(false); Member
 * loginMember=(Member)session.getAttribute("loginMember");
 * if(loginMember.getUserId().equals("admin")) { //로그인을 했다... 회원보기 요청한 아이디랑
 * 일치하면.... //화면보여줘 chain.doFilter(request, response); }else {
 * request.setAttribute("msg", "권한이 없습니다. :("); request.setAttribute("loc",
 * "/"); request.getRequestDispatcher("/views/common/msg.jsp") .forward(request,
 * response); } chain.doFilter(request, response); }
 * 
 *//**
	 * @see Filter#init(FilterConfig)
	 *//*
